...
export default InputChat = (props) => {
    return (
        <View style={{ marginHorizontal: getWidthPixel(15), marginTop: getHeightPixel(10), ...props.style }}>
            ...
            <View style={{ ...styles.inputContainer, height: props.height ? props.height : Platform.OS == 'ios' ? getHeightPixel(45) : '100%', ...props.innerStyle }}>
                <TextInput
