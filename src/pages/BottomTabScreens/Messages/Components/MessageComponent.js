            ...
            <View style={styles.content2Wrapper}>
                ...
                <View
                    style={{
                        ...
                        paddingBottom: Platform.OS == 'android' && isKeyboardVisible ? 20 : 0
                    }}
                >
                ...
                <TextInput
                    style={[
                        styles.search,
                        {
                            textAlign: "left", flex: 1, ...font(14), color: colors.gray,
                            paddingBottom: Platform.OS == 'android' && isKeyboardVisible ? 20 : 0
                        },
                    ]}
                    autoCorrect={false}
                ...
                <TouchableOpacity onPress={props.sendPressed}>
                    <Image
                        ...
                        style={{ width: 40, height: 40, marginBottom: Platform.OS == 'android' && isKeyboardVisible ? 20 : 0 }}
                    />
                </TouchableOpacity>
            </View>
            {
