...
import { ShowInitialsOfName } from "../../Components/ShowInitialsOfName";
import { getHeightPixel, getWidthPixel, showInitials } from "../../helper";
...
export default class SearchableDropDown extends Component {
  constructor(props) {
    ...
    this.makeFocussed = this.makeFocussed.bind(this);
    this.state = {
      item: {},
      listItems: [],
      focus: false,
