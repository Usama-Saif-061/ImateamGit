...
import { getHeightPercentage, getHeightPixel } from "../../helper";
  ...
  return (
    ...
    >
      <View style={AddInterestModalStyles.ModalContainer}>
        ...
        <WebView
          source={{
            uri: "https://docs.google.com/gview?embedded=true&url=https://s3.us-west-2.amazonaws.com/media.imateam/web-assets/docs/Copyright.pdf",
          }}
